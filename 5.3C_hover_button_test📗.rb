...
class DemoWindow < Gosu::Window
  ...
  def draw()
    ...
    # ????
    # Draw the button
    Gosu.draw_rect(48, 48, 104, 54, Gosu::Color::BLACK, ZOrder::MIDDLE, mode=:default) if mouse_over_button(mouse_x, mouse_y)
    ...
    @info_font.draw("Click me", 75, 68, ZOrder::TOP, 1.5, 1.5, Gosu::Color::BLACK)
  end
