...
class StarWars < Gosu::Window
    ...
    def draw
        if (@screen == 0)
            ...
            @font.draw('<i>(By BLOODMOON)</i>', 249, 210, 0, 1.4, 1.4, Gosu::Color::RED)
            ...
            @font.draw('Shoot it 20 times to earn 15 scores. Be careful, if your ship crashed into the mother ship, it will lose 4 lives.', 20, @instruction_y + 430, 0, 0.5, 0.5, Gosu::Color::GRAY)
